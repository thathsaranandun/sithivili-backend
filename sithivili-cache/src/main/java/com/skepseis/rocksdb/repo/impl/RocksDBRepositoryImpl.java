package com.skepseis.rocksdb.repo.impl;

import com.skepseis.rocksdb.repo.KeyValueRepository;
...
public class RocksDBRepositoryImpl implements KeyValueRepository<String, String> {
    ...
    void initialize() {
        ...
        try {
            ...
            log.error("Error initializng RocksDB, check configurations and permissions");
        }
    ...
    public String find(String key) {
        ...
        try {
            ...
            log.error("Error retrieving the entry in RocksDB from key: {}", key);
        }
        return result;
    }
